        ...
        <div className="container-fluid">
            <div className="row">
                <h3 className="title">Let's talk!</h3>
                    <div className="col">
                        <a href="https://api.whatsapp.com/send?phone=5493804633698&text=Let's%20Talk" target="_blank" rel="noopener noreferrer">
                        ...
                        <a href="https://www.instagram.com/varg_svart/?hl=es-la" target="_blank" rel="noopener noreferrer">
                        ...
                        <a href="https://www.linkedin.com/in/angel-magaquian-32554517a/" target="_blank" rel="noopener noreferrer"> 
                        ...
                        <a href="https://unruffled-brahmagupta-3ab98e.netlify.app/" target="_blank" rel="noopener noreferrer"> 
                        ...
                        <a href="https://github.com/AngelMagaquian" target="_blank" rel="noopener noreferrer"> 
                    ...
                    <div className="col">
                        <div className="author-container">
                            <p className='text'>Design by Angel Magaquian</p>
